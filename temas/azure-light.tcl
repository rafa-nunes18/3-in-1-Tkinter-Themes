...
namespace eval ttk::theme::azure-light {
    ...
    LoadImages [file join [file dirname [info script]] azure-light]

    # Settings
    ttk::style theme create azure-light -parent default -settings {
        ttk::style configure . \
        ...
        ttk::style layout TCombobox {
            TCombobox.field -sticky nswe -children {
                TCombobox.padding -expand true -sticky nswe -children {
                    TCombobox.textarea -sticky nswe
                }
            }
            TCombobox.button -side right -sticky ns -children {
                TCombobox.arrow -sticky nsew
            }
        }
        ...
        ttk::style element create Switch.Checkbutton.indicator image \
            [list $I(off-basic) \
                ...
                {pressed !selected} $I(off-pressed) \
                active $I(off-hover) \
            ] -width 46 -sticky w
        ...
        ttk::style element create TCombobox.field \
            image [list $I(box-basic) \
        ...
        ttk::style element create TCombobox.button \
        ...
        ttk::style element create TCombobox.arrow image $I(down) \
            -width 15 -sticky e

        # TCombobox Popdown  
        ttk::style layout TCombobox.Popdown {  
            Combobox.list -sticky nswe  
        }  
        # Criar um estilo para o Combobox  
        ttk::style configure MyCombobox.TCombobox -fieldbackground white -selectbackground lightblue -selectforeground black  
        ttk::style map MyCombobox.TCombobox -background {readonly green} -foreground {readonly black}  

        
     

        ttk::style configure TCombobox.Listbox -background red -foreground white   
